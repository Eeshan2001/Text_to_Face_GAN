            ...
            for i, real_data in enumerate(train_iter):
                ...
                if self.global_step >= (self.latest_switch + self.transition_iters):
                    ...
                    if self.is_transitioning:
                        ...
                        self.update_transition_value()
                        print(
                            f"Stopping transition. Global step: {self.global_step}, transition_variable: {self.transition_variable}, Current imsize: {self.current_imsize}")
                        ...
                        print(
                            f"Start transition. Global step: {self.global_step}, transition_variable: {self.transition_variable}, Current imsize: {self.current_imsize}")
                        self.dataloader_train = load_dataset(
